...
impl Interpreter {
    ...
    #[pyo3(signature = (target, language_features=None, project_root=None, pauli_noise=None, read_file=None, list_directory=None, resolve_path=None, fetch_github=None))]
    #[new]
